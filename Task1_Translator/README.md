...
##Technologies used : HTML,CSS,JavaScript,Web Speech API,Google Translation APIs
...
4.The input language will be automatically detected.
5.Select the target language you want the text translated into.
